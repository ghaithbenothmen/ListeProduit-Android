...
public class ProduitView extends BaseAdapter {
    ...
    public ProduitView(Activity context , ArrayList<Produit> produits) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView =inflater.inflate(R.layout.produitview, null);
        }
        //************************************
